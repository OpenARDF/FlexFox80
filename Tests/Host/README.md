...
The source contracts also require the release-pair definitions and their reporting paths to remain aligned. The current candidate identity is ESP `2.14` plus AVR `0.204`, reported together as `SW_VERSIONS,2.14,0.204`.
