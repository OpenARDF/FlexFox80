...
| R10 | A/B | High | AVR RTC/ISR timing | Level-1 counted-edge recovery prevents a multi-second normal-priority blockage from losing RTC ticks | [RTC edge recovery](Evidence/AVR_RTC_EDGE_RECOVERY_2026-07-13.md) and [target verification](Evidence/AVR_RTC_EDGE_TARGET_VERIFICATION_2026-07-13.md); host/build and focused 3.004-second target-delay gates pass | A8 broader regression | Complete |
