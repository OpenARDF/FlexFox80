...
| B-TIME-01 | B | High | ESP/Linkbus/AVR RTC | Rare field outlier; reset-dependent one-second system-time quantization reproduced | Corrected target/master pass reset gates; corrected clone/readback transfers all files and repeats a 479–506 ms target lag | Repeat corrected clones; retain drift evidence | Implementing |
