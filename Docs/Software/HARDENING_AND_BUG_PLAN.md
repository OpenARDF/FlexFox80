...
| R12 | A/B | High | AVR sleep/wake concurrency | Foreground wake-time stores are atomic to the RTC ISR; same-priority TCB0-to-PORTA ownership remains unchanged | [Wake-time atomic stores](Evidence/AVR_WAKE_TIME_ATOMIC_STORES_2026-07-13.md); red/green contract and exact zero-warning AVR build pass without resource growth | Focused target gate; A8 sleep/wake regression | Implementing |
