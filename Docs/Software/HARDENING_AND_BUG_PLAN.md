...
| B-TIME-01 | B | High | ESP/Linkbus/AVR RTC | Rare field outlier; multi-unit physical phase series pending | AVR/ESP controls built; queued writes pass; one-unit characterization isolates transient multi-second report-delivery tails | Update a second unit, run full clone/readback/cleanup and physical phase measurements | Implementing |
