...
| R14 | A/B | High | AVR RTC synchronization | RTC-edge waits are bounded and RTC reads cannot commit across a counted edge | [Bounded RTC synchronization guard](Evidence/AVR_RTC_SYNC_GUARD_2026-07-13.md); red/green host tests, firmware contracts, generated code, and exact zero-warning AVR build pass | Isolated missing-edge/intervening-edge target injection and exact restoration | Implementing |
