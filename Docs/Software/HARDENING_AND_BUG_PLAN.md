...
| R10 | A/B | High | AVR RTC/ISR timing | Level-1 counted-edge candidate recovers coalesced RTC ticks without changing RF keying or standby clocks | [Clock-edge and jitter audit](Evidence/AVR_CLOCK_EDGE_AND_JITTER_AUDIT_2026-07-13.md) and [RTC edge recovery](Evidence/AVR_RTC_EDGE_RECOVERY_2026-07-13.md); target delay/fault injection pending | A5/A6 | Implementing |
