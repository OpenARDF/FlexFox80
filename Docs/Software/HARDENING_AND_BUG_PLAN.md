...
- The hardware-compatible ESP8266 core and LittleFS profile is now qualified. The [role-assignment correction](Evidence/ESP_ROLE_ASSIGNMENT_2026-07-13.md) passes its red/green host test, source contract, immediate-baseline comparison, and two exact candidate sketch builds. Distinct-role target verification remains before completion.
...
| R8 | A/B | Medium | ESP role assignment | Complete role prefixes select cached power/frequency for role 0, role 1, and multi-digit roles | [Role-assignment correction](Evidence/ESP_ROLE_ASSIGNMENT_2026-07-13.md); red/green bounds test, source contract, exact pre-fix comparison, and two deterministic candidate sketch builds pass | Distinct-role connected-target fixture and restoration | Implementing |
