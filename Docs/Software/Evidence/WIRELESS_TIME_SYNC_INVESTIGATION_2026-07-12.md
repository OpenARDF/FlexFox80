...
**Status:** Investigation active; clone/readback controls pass, reset-dependent one-second AVR system-time quantization is reproduced, and the edge-aligned fix passes target five-reset qualification
