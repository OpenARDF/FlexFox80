...
- [FlexFox80 v2.0.2 release record](Releases/v2.0.2/README.md) records the wireless AVR handoff maintenance release, complete 17-unit candidate basis, exact published assets, and final wireless-reflash boundary.
