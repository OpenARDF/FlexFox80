...
- ESP 2.26 stages a page-aligned FlexFox product image and dual-slot recovery state in LittleFS before requesting bootloader entry;
...
- bootloader traffic uses USART1 PC0/PC1; the candidate default is 38,400 baud, and ESP 2.26 can discover 9,600, 19,200, 38,400, 57,600, or 115,200 baud for qualification and recovery;
